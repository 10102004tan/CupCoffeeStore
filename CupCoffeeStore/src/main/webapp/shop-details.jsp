					...
					<div class="row">
						<div class="col-md-6">
							<div class="images p-3">
								<div class="text-center p-4">
									<img id="main-image" src="images/<%=sanPham.getHinh() %>"
										width="400" />
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="product p-4">
								...
								<div class="mt-4 mb-3">
									<span class="text-uppercase text-muted brand"><%=sanPham.getXuatXu() %></span>
									<h5 class="text-uppercase product__name"><%=sanPham.getTen()%></h5>
									<div class="price d-flex flex-row align-items-center">
										Price : <span class="act-price format-price"><%=sanPham.getGia()%></span>

									</div>
								</div>
								<p class="about"><%=sanPham.getMoTa()%></p>

								<div class="cart mt-4 align-items-center">
									<a href="AddToCart?ma=<%=sanPham.getMa()%>"
